<div class="section-header my-4 py-4">
    <h2 class="fw-bold text-center">Sarana dan Prasarana</h2>
    <span class="d-flex justify-content-center text-center">Beberapa Fasilitas yang tersedia di SMP Yaspen Tugu Ibu 2</span>
</div>
<div class="container mb-4">
    <div class="row row-cols-1 row-cols-md-2 g-4">
        ...
        <div class="col">
            <div class="card">
                <img src="<?= base_url('assets/'); ?>/images/sarana/mushola.jpeg" class="card-img-top" alt="...">
                <div class="card-body">
